    ...
    <>
      ...
      <div className="">
        ...
        <ul>
          ...
          <li>
            <p><strong>Application</strong> refers to Simple Journal, the software program provided by the
              Company.</p>
          </li>
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
              or &quot;Our&quot; in this
              Agreement) refers to Simple Journal.</p>
          </li>
          <li>
        ...
        <p>Application does not collect any personal data, means yourpersonal data and contents in
          apps are saved in your Device and limited to You,thus the data is not transferred off your
          Device to the Company or any thirdparty.
          <strong>Security of Your Personal Data</strong>
          The security of Your Personal Data is important to Us, Once the Application is deleted the
          data will no longer be available in Device or You can update/delete the data yourself in the
          Application.
        </p>
        <p><strong>Children&#39;s Privacy</strong></p>
        <p>Since the Data is not transmitted off the Device,the Application assures Children’s Privacy.</p>
        <p><strong>Changes to this Privacy</strong></p>
